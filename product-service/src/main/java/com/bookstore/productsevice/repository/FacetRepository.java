...
public interface FacetRepository  {
    ...
    public static final String HOURLY_RATE_BUCKETS_NAME = "hourlyRateBuckets";
    ...
    public static final Double[] HOURLY_RATE_USD_RANGES = new Double[] {0.0,25.0,50.0,75.0,100.0,150.0};
