...
export default function ApplyForTaskMaster() {
    ...
    if (submitted) {
        return (
            <div className="new-taskmaster-page">
                <div className="form-feedback success" style={{ fontSize: '1.1rem', padding: '2rem' }}>
    ...
    return (
        <div className="new-taskmaster-page">
            <h1><i className="id card icon" /> Apply to Become a TaskMaster</h1>
            <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                Fill in the details below. Your application will be reviewed by an admin.
            </p>
